...
class Feature():
    ...
    def __init__(self):
        self.data_file = "graph_with_inv.txt"
        self.path_file = "paths_threshold_with_inv.txt"
        self.train_file = "test2id.txt"
    ...
    def get_probs(self,prob_flag="pcrw-exact",walker_num=50): # 完全按照随机游走的公式来计算路径概率
        ...
        with open("test_data_with_inv_%s.txt"%prob_flag,"w") as f:
