...
class Model:
    ...
    def __init__(self,feature_file="train_data_with_inv_pcrw-exact.txt"):
        ...
        self.path_ids = [n for n in range(17557)]
...
if __name__ == "__main__":
    ...
    model = Model(feature_file="train_data_with_inv_pcrw-exact.txt")
    model.train(stop_loss=0.01, max_iter=100000)
    m = model.save("model_LR_with_inv.pkl","result_LR_with_inv.txt")
    #load model
    # with open("model_LR_with_inv.pkl","rb") as fo:
    #     m = pickle.load(fo)
