...
class Feature():
    ...
    def __init__(self):
        relation = 'concept_personleadsorganization'
        dataPath_ = './NELL-995/tasks/' + relation
        self.data_file = dataPath_ + "/graph.txt"
        self.path_file = "./result/personleadsorganization/paths_threshold_personleadsorganization.txt"
        self.train_file = dataPath_ + "/train.pairs"
        self.test_file = dataPath_ + "/test.pairs"
    ...
    def get_probs(self,prob_flag="pcrw-exact",walker_num=50): # 完全按照随机游走的公式来计算路径概率
        ...
        with open("./result/personleadsorganization/train_data_%s_personleadsorganization.txt"%prob_flag,"w") as f:
